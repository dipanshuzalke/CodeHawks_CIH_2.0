...
export function LandingHero() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center pt-32 pb-20 px-4 sm:px-6 lg:pt-40 lg:pb-28">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[60rem] h-[30rem] opacity-20 dark:opacity-10">
